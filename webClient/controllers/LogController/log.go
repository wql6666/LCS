...
func (p *LogController) LogList() {
	...
	logs.Debug("enter logList index controller")
...
func (p *LogController) LogApply() {
	...
	logs.Debug("enter  logApply index controller")
	p.Layout = "layout/layout.html"
...
func (p *LogController) LogCreate() {
	...
	logs.Debug("enter logCreate index controller")
